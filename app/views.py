...
from .forms import CustomerProfileFoem,CustomerRegistrationForm
...
class ProfileView(View):
    def get(self, request):
        form = CustomerProfileFoem()
        return render(request, "app/profile.html", locals())
    def post(self, request):
        form = CustomerProfileFoem(request.POST)
        if form.is_valid():
            user = request.user
...
class updateAddress(View):
    def get(self, request, pk):
        ...
        form = CustomerProfileFoem(instance=add)
